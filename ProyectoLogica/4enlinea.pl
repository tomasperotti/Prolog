...
cuatro(Color, Conf, Resultado):- 
 ...
 cuatroH(Color, Conf, 0, Aux), longitud(Aux,0,Long), mostrar(4,Aux, Resultado,Long);
 trans(Conf, Traspuesta), cuatroH(Color, Traspuesta, 0, Aux), longitud(Aux,0,Long), mostrar(4,Aux, Resultado,Long);
...
tres(Color, Conf, Resultado):- cuatroH(Color, Conf, 1, Aux), longitud(Aux,0,Long), mostrar(3,Aux, Resultado,Long);
 trans(Conf, Traspuesta), cuatroH(Color, Traspuesta, 1, Aux), longitud(Aux,0,Long), mostrar(3,Aux, Resultado,Long);
...
% Si es true retorna la lista que conforma dos en linea, si es false retorna false.
 ...
 dos(Color, Conf, Resultado):- cuatroH(Color, Conf, 2, Aux), longitud(Aux,0,Long), mostrar(2,Aux, Resultado,Long);
 trans(Conf, Traspuesta), cuatroH(Color, Traspuesta, 2, Aux), longitud(Aux,0,Long), mostrar(2,Aux, Resultado,Long);
...
jugada_segura(Color, Conf, R) :- jugada_inicial(Color, Conf, R).
jugada_segura(Color, Conf, R) :- colocar_ficha(Color, R, Conf, ConfRes), tres(Color, ConfRes, Tres).
jugada_segura(Color, Conf, R) :- colocar_ficha(Color, R, Conf, ConfRes), dos(Color, ConfRes, Dos).
